...
public class CustomerInfoController {
    ...
    public Map<String, Object> list() {
        List<User> list = userDao.getCustomerInfo();
        return R.r(list, "list", 200);
    }
...
//        System.out.println(type);
        ...
        List<User> list = userDao.searchCustomer(hashMap);
    ...
    @PostMapping("/add")
    public Map<String, Object> addCustomer(@RequestBody User user) {
...
//    @PostMapping("/delete")
//    public Map<String, Object> delCustomer(@RequestBody User user) {
//        if (userDao.delById(user.getId()) == 1) {
...
//    public Map<String, Object> delIdsCustomer(@RequestBody Map<String, String[]> ids) {
...
//    }
    ...
    public Map<String, Object> updateCustomer(@RequestBody User user) {
        User byId = userDao.getCustomerById(user.getId());
        List<User> userKey = userDao.getUserKey(user);
        for (User u : userKey) {
            if (u != null) {
    ...
    public Map<String, Object> listByidentity(@RequestParam("identity") String identity) {
        System.out.println(identity);
        return R.r(userDao.getCustomerByIdentity(identity), "", 200);
    }
